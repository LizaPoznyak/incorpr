...
import Avatar1 from 'C:/Users/admin/incorpr repository/incorpr_react/src/img/avatar 1.png';
import Avatar2 from 'C:/Users/admin/incorpr repository/incorpr_react/src/img/avatar 2.png';
import Avatar3 from 'C:/Users/admin/incorpr repository/incorpr_react/src/img/avatar 3.png';
            ...
            <main>
                ...
                <div className="sections">
                    ...
                    <div className="section">
                        <div className="head">
                            <h2>Сотрудники</h2>
                            <Link to="/staff" class="more"><h2>Ещё ❯</h2></Link>
                        </div>
                        <div className="avatars">
                            <Link to="/staff/id"><img class="avatar" src={Avatar1} alt="avatar 1"/></Link>
                            <Link to="/staff/id"><img class="avatar" src={Avatar2} alt="avatar 2"/></Link>
                            <Link to="/staff/id"><img class="avatar" src={Avatar3} alt="avatar 3"/></Link>
                            <Link to="/staff/id"><img class="avatar" src={Avatar4} alt="avatar 4"/></Link>
                        </div>
                    </div>
                </div>
            </main>
