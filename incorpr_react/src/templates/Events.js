...
const Events = () => {
    const selectMenuItem = (selectedItem) => {
        const items = document.querySelectorAll('.type-filter');
        items.forEach(item => {
        ...
        <div>
            ...
            <main className="container">
                <div className="main-content">
                    <h1>Мероприятия</h1>
                    <div>
                        <img className="banner" src="C:/Users/admin/incorpr repository/incorpr_react/src/img/banner.png" alt="banner"/>
                    </div>
                    <div className="section">
                        ...
                        <a href="/events/11" className="black">
                            <div className="event">
                                <p className="date">21.10.24</p>
                                <p>TechQuest: Новые горизонты киберпространства</p>
                                <p className="type">Хакатон</p>
                            </div>
                        </a>
                        <a href="/events/12" className="black">
                            <div className="event">
                                <p className="date">19.10.24</p>
                                <p>Кибербезопасность: Защита данных в цифровую эпоху</p>
                                <p className="type">Вебинар</p>
                            </div>
                        </a>
                        <a href="/events/13" className="black">
                            <div className="event">
                                <p className="date">18.10.24</p>
                                <p>Блокчейн и криптовалюты: Что нужно знать сегодня</p>
                                <p className="type">Вебинар</p>
                            </div>
                        </a>
                        <a href="/events/33" className="black">
                            <div className="event">
                    ...
                    <div className="add-btn"> 
                        <a href="/events/add" className="abtn centered-text-btn">Добавить</a>
                    </div> 
                </div> 
                <aside className="sidebar"> 
                    <div className="filter-section"> 
                        ...
                        <div className="filter-container"> 
                            <div className="row"> 
                                <p className="type-filter active" onClick={() => selectMenuItem(this)}>Все</p> 
                                <p className="type-filter" onClick={() => selectMenuItem(this)}>Хакатон</p> 
                            </div> 
                            <div className="row"> 
                                <p className="type-filter" onClick={() => selectMenuItem(this)}>IT-конференция</p> 
                                <p className="type-filter" onClick={() => selectMenuItem(this)}>Вебинар</p> 
                            </div> 
                        </div> 
                    </div> 
                    <div className="sidebar-section"> 
                        ...
                        <a href="/events/11" className="black"> 
                            <div className="odd"> 
                                ...
                                <p className="sidebar-p">Кибербезопасность: Защита данных в цифровую эпоху</p> 
                            </div> 
                        </a> 
                        <a href="/events/12" className="black"> 
                            <div className="even"> 
                                ...
                                <p className="sidebar-p">Блокчейн и криптовалюты: Что нужно знать сегодня</p> 
                            </div> 
                        </a> 
                        <a href="/events/13" className="black"> 
                            <div className="odd"> 
                                ...
                                <p className="sidebar-p">Веб-разработка: Современные технологии и практики</p> 
                            </div> 
                        </a> 
                        <a href="/events/33" className="black"> 
                            <div className="even"> 
                                ...
                                <p className="sidebar-p">Клауд-технологии: Облако для бизнеса и личных нужд</p> 
                            </div> 
                        </a> 
                    </div> 
                </aside> 
