                            ...
                            <div className="profile-info-container-profile">
                                <div className="row-profile">
                                    <div className="avatar-container-profile">
                                        <img className="avatar-profile" src={`http://localhost:8080${user.avatar_url}`} alt={`avatar of ${user.username}`} onError={(e) => e.target.src = 'http://localhost:8080/uploads/avatars/default%20avatar.jpg'} />
                                    </div>
                                ...
                                <div className="icons-profile">
                                    {(currentUserRole === 'ADMIN' || currentUserId === user.id.toString()) && (
                                        <>
                                            <Link to={`/staff/${user.id}/edit`} title='Редактировать'>
