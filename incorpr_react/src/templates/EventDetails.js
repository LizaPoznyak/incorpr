...
const EventDetails = () => {
    ...
    const handleRegister = async () => {
        try {
            const response = await axios.post(`http://localhost:8080/events/${id}/register`, { userId: 1 }, {
                headers: {
    ...
    const handleCancelRegistration = async () => {
        try {
            const response = await axios.post(`http://localhost:8080/events/${id}/cancel-registration`, { userId: 1 }, {
                headers: {
                    'Content-Type': 'application/json'
                }
            });
                    ...
                    <div className="section-event-details">
                        <div className="type-event-details">
                            <div className="event-info-event-details">
                                ...
                                <h2 className="date-event-details top5-event-details">{new Date(event.dateTime).toLocaleString()}</h2>
                            </div>
                        </div>
