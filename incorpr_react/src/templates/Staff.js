                            ...
                            <Link to={`/staff/${employee.id}`} className="link-staff" key={employee.id}>
                                <div className="employee-staff">
                                    <div className="employee-info-staff">
                                        <img className="avatar-staff" src={`http://localhost:8080${employee.avatar_url}`} alt={`avatar of ${employee.username}`} onError={(e) => e.target.src = 'http://localhost:8080/uploads/avatars/default%20avatar.jpg'} />
